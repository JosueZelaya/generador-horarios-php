<div class="panel panel-default col-sm-11">     
    <div class="panel-heading" style="background: white">
        ...
        <div id='cuadro-busqueda' class="input-group col-sm-4 cuandro-busqueda">
            <?php require_once 'cuadroBusquedaMaterias.php'; ?>
        </div>
        <br/>
        ...
        <div class="">
            <div id="example2_wrapper" class="dataTables_wrapper form-inline" role="grid">                
                ...
                <thead id='cabeceraEliminar' class='cabeceraEliminar'>
                    <?php require_once 'cabeceraTablaMaterias.php'; ?>
                </thead>
                ...
                <tbody id="mostrarEliminar" class="mostrarEliminar">                
                    <?php require_once 'contenidoTablaMaterias.php'; ?>
                </tbody>                
            </table>
            ...
            <div class="row">                
                <div class="col-xs-12">
                    <div class="dataTables_paginate paging_bootstrap">
                        <div id="paginacion">
                                <?php $css_class="paginaMateriasEliminar"; require_once 'paginadorMaterias.php'; ?>
                        </div>                        
                    </div>
                </div>
            </div>
