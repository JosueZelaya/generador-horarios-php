...
<!--                <table class="table table-condensed table-striped table-hover ">-->
                <thead>
                    <tr>                        
                        <th data-toggle="true" class="text-left footable-first-column">Codigo</th>
                        <th class="text-left">Nombre</th>
                        <th class="text-left">Plan</th>
                        <th class="text-left">Carrera</th>
                        <th class="text-left">Ciclo</th>                        
                        <th class="text-left">Unidades Valorativas</th>                        
                        <th class="text-left">Tipo</th>                        
                    </tr>
                </thead>                
                <tbody id="mostrarMaterias" class="mostrarMaterias">

                    <?php include_once 'contenidoTablaMaterias.php'; ?>
                </tbody>                
            </table>
            <div class="row">                
                <div class="col-xs-12">
                    <div class="dataTables_paginate paging_bootstrap">
                        <div id="paginacion">
                                <?php $css_class='paginaMaterias'; require_once 'paginadorMaterias.php'; ?>
                        </div>                        
                    </div>
                </div>
            </div>
