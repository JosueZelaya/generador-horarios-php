...
$(document).ready(function() {
    ...
    $(document).on("click",".alternados",function(){        
        var dataString = "id="+$(this).attr('id')+"&campo=grupos_alternados&valor="+document.getElementById($(this).attr('id')).checked;                
        $.ajax({
            type: "GET",
            url: "modificarAgrupacion.php",
            data: dataString,
