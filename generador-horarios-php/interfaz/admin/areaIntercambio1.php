        ...
        for($j=0;$j<count($tabla[$i]);$j++){                
            if($j==0){
                ...
                if(!strcmp($celda['grupo'],"")==0){
                    echo "<div class='celda-hora intercambio1 grupoIntercambio1 intercambio1".$celda['codigo'].$celda['grupo'].$i."  intercambio1".$celda['dia'].$celda['idHora']."' data-grupo='".$celda['codigo'].$celda['grupo'].$i."' data-iniciobloque='".$celda['inicioBloque']."' data-finbloque='".$celda['finBloque']."' data-hora='".$celda['idHora']."' data-dia='".$celda['dia']."'>";                    
                    if($j<3){
