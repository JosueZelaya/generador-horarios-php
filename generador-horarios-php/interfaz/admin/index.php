                ...
                <div class="row">
                    <div class="col-lg-3">
                        <a href="../agrupaciones_crear/index.php" target="_blank">
                            <span><i class="fa fa-cubes fa-lg"></i></span>
                    ...
                    <div class="col-lg-3">
                        <a href="../agrupaciones_docentes/index.php" target="_blank">
                            ...
                            <span><i class="fa fa-male fa-lg"></i><i class="fa fa-female fa-lg"></i></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <a href="../agrupaciones_aulas/index.php" target="_blank">
                            ...
                            <span><i class="fa fa-building fa-lg"></i></span>
                ...
                <div class='row'>
                    <div class="admin-users col-lg-3">
                        <a href="#admin_materias_modal" data-toggle="modal">
                            ...
                            <span><i class="fa fa-book fa-lg"></i></span>
                    ...
                    <div class="admin-users col-lg-3">
                        <a href="#admin_aulas_modal" data-toggle="modal">
                            ...
                            <span><i class="fa fa-university fa-lg"></i></span>
                    ...
                    <div class="admin-users col-lg-3">
                        <a href="#admin_departamentos_modal" data-toggle="modal">
                            ...
                            <span><i class="fa fa-sitemap fa-lg"></i></span>
