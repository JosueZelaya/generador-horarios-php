...
$cantidadMaterias = $_SESSION['num_filas'];
...
if($paginasNecesarias>5){
        ...
        for ($index2 = $pagina-2; $index2 <= $pagina+2; $index2++) {
            if($pagina==$index2){
                echo "<li class='active'><a class='paginaMaterias' data='".$index2."' href='#'>".$index2."</a></li>";
            }else{
                echo "<li><a class='paginaMaterias' data='".$index2."' href='#'>".$index2."</a></li>";
            }        
        }
        ...
        for ($index = 0; $index < 5; $index++) {                                        
            if($pagina==$index+1){
                $page=$index+1;
                echo "<li class='active'><a class='paginaMaterias' data='".$page."' href='#'>".$page."</a></li>";
            }else{
                $page=$index+1;
                echo "<li><a class='paginaMaterias' data='".$page."' href='#'>".$page."</a></li>";
            }                                        
        }
        echo "<li class='next'><a href='#'> → </a></li>"
        . "</ul>";
