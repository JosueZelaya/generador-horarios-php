        ...
        for ($j = 0; $j < count($tabla[$i]); $j++) {
            if ($j == 0) {
                ...
                if(!strcmp($celda['grupo'],"")==0){
                    echo "<div class='celda-hora intercambio2 grupoIntercambio2 intercambio2". $celda['codigo'].$celda['grupo'].$celda['tipo'].$i." intercambio2".$celda['dia'].$celda['idHora']."' data-grupo='".$celda['codigo'].$celda['grupo'].$celda['tipo'].$i."' data-iniciobloque='" . $celda['inicioBloque'] . "' data-finbloque='" . $celda['finBloque'] . "' data-hora='" . $celda['idHora'] . "' data-dia='".$celda['dia']."'>";
